<?php
	define( 'TECH_ROOT', dirname(__FILE__) );
	require_once TECH_ROOT . '/inc/components/product.php';
	require_once TECH_ROOT . '/inc/components/product-1.php';
	require_once TECH_ROOT . '/inc/components/product-card.php';
	require_once TECH_ROOT . '/inc/components/product-with-rating.php';
	require_once TECH_ROOT . '/inc/components/product-no-hover.php';
...
<html lang="fa" dir="ltr" itemscope="itemscope" itemtype="http://schema.org/WebPage">
	...
	<body class="<?php echo $bodyClass;?>">
		<div id="page" class="hfeed site">
			...
			<?php require_once TECH_ROOT.'/inc/header/header.php'; ?>

			<?php require_once TECH_ROOT.'/pages/'.$page.'.php'; ?>

			<?php require_once TECH_ROOT.'/inc/footer/footer.php'; ?>
