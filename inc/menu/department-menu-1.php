<div id="departments-menu" class="dropdown departments-menu">
	...
	<ul id="menu-departments-menu" class="dropdown-menu yamm departments-menu-dropdown">
		<li class="highlight menu-item animate-dropdown">
		 	<a title="Value of the Day" href="index.php?page=home-v2">Value of the Day</a>
		</li>

		<li class="highlight menu-item animate-dropdown">
		 	<a title="Top 100 Offers" href="index.php?page=home-v3">Top 100 Offers</a>
		</li>

		<li class="highlight menu-item animate-dropdown">	
			<a title="New Arrivals" href="index.php?page=home-v4">New Arrivals</a>
		</li>
		...
		<li class="menu-item menu-item-type-custom animate-dropdown">
			<a title="Gadgets" href="index.php?page=landing-page-v1">Diet Products</a>
		</li>

		<li class="menu-item menu-item-type-custom animate-dropdown">
			<a title="Virtual Reality" href="index.php?page=landing-page-v2">Professional Lines</a>
		</li>
	</ul>
