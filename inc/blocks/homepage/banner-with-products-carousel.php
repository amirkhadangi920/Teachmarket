...
<div class="home-v3-banner-with-products-carousel row">
	<div class="banner column-1">
		<a href="#"><div style="background-size: cover; background-position: center center; background-image: url( assets/images/banner/home-v3-banner.jpg ); height: 321px;" class="banner-bg"><div class="caption"><div class="banner-info"><h3 class="title">ملزومات<br> از <strong>گجت های<br> پوشیدنی</strong></h3></div>
			<span class="banner-action button">	نمایش همه</span></div></div>
		</a>
	</div><!-- .banner -->	
