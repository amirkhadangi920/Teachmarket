...
<section id="section-products-carousel-6" class="section-landscape-products-carousel section-landscape-products-carousel-with-thumbnails">
	<header class="section-header">
		<h2 class="section-title">تلویزیون فول hd و 4K</h2>
		                	...
		                	<div class="media">	
	            				...
	            				<div class="media-body">
	            					<a href="index.php?page=single-product-fullwidth" class="woocommerce-LoopProduct-link">
	            						...
	            						<h2 class="woocommerce-loop-product__title">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت.</h2>
	            					...
	            					<a rel="nofollow" href="index.php?page=cart" class="button product_type_simple">اضافه کردن به لیست خرید</a>
	            					<a href="index.php?page=compare" class="add-to-compare-link">مقایسه کردن</a>
	            				</div><!-- /.media-body -->
		                	</div><!-- /.media -->
