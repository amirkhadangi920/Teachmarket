<div id="comments" class="comments-area">
    ...
    <h2 class="comments-title"> 3 پیام</h2>
		...
		<li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1">
		    <div class="comment_container">
				...
				<div class="comment-text">
					<div class="meta">
						<strong class="woocommerce-review__author" itemprop="author">گروه SmaT </strong>
						<time datetime="2017-03-23T08:06:09+00:00" class="woocommerce-review__published-date">4/8/1397</time>
					</div>

					<div class="comment-content">
						<div class="description"><p>خوب</p>
						</div>

						<div class="reply">
							<a class="comment-edit-link" href="#">ویرایش</a>							
							<a href="index.php?page=blog-single#respond" class="comment-reply-link" rel="nofollow">تکرار</a>
						</div><!-- .reply -->
					</div><!-- .comment-content -->
				</div><!-- .comment-text -->
		...
		<li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1">
		    <div class="comment_container">
				...
				<div class="comment-text">
					...
					<div class="comment-content">
						<div class="description"><p>بینظیر</p>
						</div>
    ...
    <div class="comment-respond" id="respond">
        <h3 class="comment-reply-title" id="reply-title">پاسخ دهید</h3>
