            ...
            <div id="content" class="site-content">
                <div class="col-full">
                    <div class="row">
                        ...
                        <div id="primary" class="content-area pkh-text-right">
                            <main id="main" class="site-main">
                                <div class="type-page hentry">
                                    ...
                                    <div class="entry-content">
                                            ...
                                            <div class="col-md-6">
                                                <div class="text-block">
                                                    ...
                                                    <div class="text-content">
                                                        <p>Nullam dignissim elit ut urna rutrum, a fermentum mi auctor. Mauris efficitur magna orci, et dignissim lacus
                                        ...
                                        <!-- .row -->
                                        <h2 class="faq-title-v2">FAQ Second Version</h2>
                                        <div class="faq-subtitle">This Agreement was last modified on 01 June 2017.</div>
