                        ...
                        <div class="media-body">
                            <div class="clearfix">
                                <div class="newsletter-header">
                                    <h5 class="newsletter-title">ثبت نام به خبرنامه</h5>
                                    <span class="newsletter-marketing-text">... و دریافت کنید
                                        <strong>تومان 20 کوپن برای اولین بار خرید</strong>
                                    </span>
                                </div>
                                <!-- .newsletter-header -->
                    ...
                    <div class="footer-logo">
                        <a href="home-v1.html" class="custom-logo-link" rel="home">
                            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 176 28">
                                ...
                                <path class="cls-1" d="M156.39,24h-1.25s-0.49-.39-0.71-0.59l-1.35-1.25c-0.25-.23-0.68-0.66-0.68-0.66s0-.46,0-0.72a3.56,3.56,0,0,0,3.54-2.87,3.36,3.36,0,0,0-3.22-4H148.8V24h-1V13.06h5c2.34,0.28,4,1.72,4.12,4a4.26,4.26,0,0,1-3.38,4.34C154.48,22.24,156.39,24,156.39,24Z"
                                ...
                                <path class="cls-1" d="M77.74,36.07a9,9,0,0,0,6.41-2.68L88,37c-2.6,2.74-6.71,4-10.89,4A13.94,13.94,0,0,1,62.89,27.15,14.19,14.19,0,0,1,77.11,13c4.38,0,8.28,1.17,10.89,4,0,0-3.89,3.82-3.91,3.8A9,9,0,1,0,77.74,36.07Z"
                                    transform="translate(-12 -13)" />
                    ...
                    <div class="contact-payment-wrap">
                        <div class="footer-contact-info">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <address class="footer-contact-address">17 Princess Road, London, Greater London
                                        NW1 8JR, UK</address>
                        ...
                        <div class="footer-payment-info">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="footer-payment-info-title">ما از پرداخت های امن استفاده می کنیم</h5>
                                    <div class="footer-payment-icons">
                                        <ul class="list-payment-icons nav">
                                            <li class="nav-item">
                                                <img class="payment-icon-image" src="/images/credit-cards/mastercard.svg"
                                                    alt="mastercard" />
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <img class="payment-icon-image" src="/images/credit-cards/paypal.svg"
                                                    alt="paypal" />
                                            </li>
                                            <li class="nav-item">
                                                <img class="payment-icon-image" src="/images/credit-cards/maestro.svg"
                                                    alt="maestro" />
                                            </li>
                                        </ul>
                                    </div>
                ...
                <div class="footer-widgets">
                    <div class="columns">
                        <aside class="widget clearfix">
                            <div class="body">
                                <h4 class="widget-title">یافتن آن سریع</h4>
                                <div class="menu-footer-menu-1-container">
                                    <ul id="menu-footer-menu-1" class="menu">
                                        <li class="menu-item">
                                            <a href="shop.html">کامپیوترها و لپ تاپ ها</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">دوربینها و عکاسی</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">دوربین ها و عکس</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">بازی های ویدئویی و کنسول ها</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">نلوزیون</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">اتومبیل الکترونیک و GPS</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="body">
                                ...
                                <div class="menu-footer-menu-2-container">
                                    <ul id="menu-footer-menu-2" class="menu">
                                        <li class="menu-item">
                                            <a href="shop.html">چاپگرها و جوهر</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">صوتی و موسیقی</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">سینمای خانگی</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">قطعات کامپیوتر</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">اولترابوک ها</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">ساعتهای هوشمند</a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="columns">
                        <aside class="widget clearfix">
                            <div class="body">
                                <h4 class="widget-title">مراقبت از مشتری</h4>
                                <div class="menu-footer-menu-3-container">
                                    <ul id="menu-footer-menu-3" class="menu">
                                        <li class="menu-item">
                                            <a href="login-and-register.html">اکانت من </a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="track-your-order.html">پیگیری سفارش</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="shop.html">فروشگاه</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="wishlist.html">لیست دلخواه</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="about.html">دربارهی ما</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="terms-and-conditions.html">برگشت و تعویض</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="faq.html">سوالات متدائل</a>
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="site-info">
            <div class="col-full">
                <div class="copyright">Copyright &copy; 2017 <a href="home-v1.html">Techmarket</a> Theme. All rights
                    reserved.</div>
                <!-- .copyright -->
                <div class="credit">درست شده
                    <i class="fa fa-heart"></i> توسط SmaT .</div>
                <!-- .credit -->
            </div>
            <!-- .col-full -->
        </div>
