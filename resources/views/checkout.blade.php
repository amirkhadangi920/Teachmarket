                ...
                <div class="col-full">
                    <div class="row">
                        <nav class="woocommerce-breadcrumb">
                            <a href="home-v1.html">صفحه اصلی</a>
                        ...
                        <div class="content-area pkh-text-right" id="primary">
                            <main class="site-main" id="main">
                                <div class="type-page hentry">
                                    <div class="entry-content">
                                        <div class="woocommerce">
                                            <div class="woocommerce-info">بازگشت مشتری? <a data-toggle="collapse" href="#login-form" aria-expanded="false" aria-controls="login-form" class="showlogin">برای ورود اینجا کلیک کنید</a>
                                            </div>
                                            ...
                                            <!-- .collapse -->
                                            <div class="woocommerce-info">یک کوپن داشته باشید? <a data-toggle="collapse" href="#checkoutCouponForm" aria-expanded="false" aria-controls="checkoutCouponForm" class="showlogin">برای وارد کردن کد خود اینجا را کلیک کنید</a>
                                            </div>
                                                                    ...
                                                                    <tr class="cart_item">
                                                                        ...
                                                                        <td class="product-total">
                                                                            <span class="woocommerce-Price-amount amount">
                                                                                <span class="woocommerce-Price-currencySymbol">تومان</span>627.99</span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="cart_item">
                                                                        <td class="product-name">
                                                                        ...
                                                                        <td class="product-total">
                                                                            <span class="woocommerce-Price-amount amount">
                                                                                <span class="woocommerce-Price-currencySymbol">تومان</span>219.00</span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="cart_item">
                                                                        <td class="product-name">
                                                                        ...
                                                                        <td class="product-total">
                                                                            <span class="woocommerce-Price-amount amount">
                                                                                <span class="woocommerce-Price-currencySymbol">تومان</span>99.95</span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="cart_item">
                                                                        <td class="product-name">
                                                                        ...
                                                                        <td class="product-total">
                                                                            <span class="woocommerce-Price-amount amount">
                                                                                <span class="woocommerce-Price-currencySymbol">تومان</span>17.00</span>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                                <tfoot>
                                                                ...
                                                                <div class="form-row place-order">
                                                                    <p class="form-row terms wc-terms-and-conditions woocommerce-validated">
                                                                        <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
                                                                            ...
                                                                            <span>من خواندن و قبول کردم <a class="woocommerce-terms-and-conditions-link" href="terms-and-conditions.html">شرایط و ضوابط</a></span>
                                                                            <span class="required">*</span>
                                                                        </label>
                                                                        <input type="hidden" value="1" name="terms-field">
                                                                    </p>
                                                                    <a href="order-received.html" class="button wc-forward text-center">سفارش محل</a>
                                                                </div>
                                                            </div>
                                                ...
                                                <div id="customer_details" class="col2-set">
                                                    <div class="col-1">
                                                        <div class="woocommerce-billing-fields">
                                                            ...
                                                            <div class="woocommerce-billing-fields__field-wrapper-outer pkh-direction-rtl">
                                                                <div class="woocommerce-billing-fields__field-wrapper">
                                                                    ...
                                                                    <p id="billing_company_field" class="form-row form-row-wide">
                                                                        <label class="" for="billing_company">نام شرکت</label>
                                                                    ...
                                                                    <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                                        <label class="" for="billing_address_1">اسم خیابان
                                                                            <abbr title="required" class="required">*</abbr>
                                                                        </label>
                                                                    ...
                                                                    <p id="billing_address_2_field" class="form-row form-row-wide address-field">
                                                                        <input type="text" value="" placeholder="آپارتمان، مجموعه، واحد و غیره (اختیاری)" id="billing_address_2" name="billing_address_2" class="input-text ">
                                                                    </p>
                                                                    ...
                                                                    <p id="billing_state_field" class="form-row form-row-wide validate-required validate-email">
                                                                        <label class="" for="billing_state">منطقه
                                                                            <abbr title="required" class="required">*</abbr>
                                                                        </label>
                                                        ...
                                                        <div class="woocommerce-account-fields">
                                                            <p class="form-row form-row-wide woocommerce-validated">
                                                                <label class="collapsed woocommerce-form__label woocommerce-form__label-for-checkbox checkbox" data-toggle="collapse" data-target="#createLogin" aria-controls="createLogin">
                                                                    ...
                                                                    <span>ایجاد یک حساب کاربری?</span>
                                                                </label>
                                                            </p>
                                                            <div class="create-account collapse" id="createLogin">
                                                                <p data-priority="" id="account_password_field" class="form-row validate-required woocommerce-invalid woocommerce-invalid-required-field">
                                                                    <label class="" for="account_password">رمز عبور حساب کاربری
                                                                        <abbr title="required" class="required">*</abbr>
                                                                    </label>
                                                    ...
                                                    <div class="col-2">
                                                            ...
                                                            <div class="shipping_address collapse" id="shipping-address">
                                                                <div class="woocommerce-shipping-fields__field-wrapper">
                                                                    ...
                                                                    <p id="shipping_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                                        <label class="" for="shipping_address_1">خیابان
                                                                            <abbr title="required" class="required">*</abbr>
                                                                        </label>
                                                                    ...
                                                                    <p id="shipping_state_field" class="form-row form-row-wide address-field validate-state woocommerce-invalid woocommerce-invalid-required-field validate-required" data-o_class="form-row form-row-wide address-field validate-required validate-state woocommerce-invalid woocommerce-invalid-required-field">
                                                                        <label class="" for="shipping_state">منطقه
                                                                            <abbr title="required" class="required">*</abbr>
                                                                        </label>
                                                        ...
                                                        <div class="woocommerce-additional-fields pkh-direction-rtl">
                                                            <div class="woocommerce-additional-fields__field-wrapper">
                                                                <p id="order_comments_field" class="form-row notes">
                                                                    <label class="" for="order_comments">سفارش یادداشت ها</label>
                                                                    <textarea cols="5" rows="2" placeholder="یادداشت های مربوط به سفارش شما، به عنوان مثال یادداشت های ویژه برای تحویل" id="order_comments" class="input-text " name="order_comments"></textarea>
                                                                </p>
                                                            </div>
