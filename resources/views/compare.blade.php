                                ...
                                <div class="type-page hentry">
                                    <div class="entry-content">
                                        <div class="table-responsive">
                                            <table class="table table-compare compare-list pkh-direction-rtl pkh-text-right">
                                                <tbody>
                                                    <tr>
                                                        <th>محصولات</th>
                                                        <td>
                                                            <a class="product" href="single-product-fullwidth.html">
                                                                <div class="product-image">
                                                                    <div class="image">
                                                                        <img width="300" height="300" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="/images/products/1-2.jpg">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <td>
                                                            <a class="product" href="single-product-fullwidth.html">
                                                                <div class="product-image">
                                                                    <div class="image">
                                                                        <img width="300" height="300" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="/images/products/big-2.jpg">
                                                                    </div>
                                                                </div>
                                                                <div class="product-info">
                                                        ...
                                                        <td>
                                                            <a class="product" href="single-product-fullwidth.html">
                                                                <div class="product-image">
                                                                    <div class="image">
                                                                        <img width="300" height="300" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="/images/products/deals-3.jpg">
                                                                    </div>
                                                                </div>
                                                                <div class="product-info">
                                                    ...
                                                    <tr>
                                                        <th>اضافه به سبد</th>
                                                        <td>
                                                            <a class="button" href="cart.html">اضافه به سبد</a>
                                                        </td>
                                                        <td>
                                                            <a class="button" href="cart.html">اصافه به سبد</a>
                                                        </td>
                                                        <td>
                                                            <a class="button" href="cart.html">اضافه به سبد</a>
                                                        </td>
